...
export const organizeAssignmentMaterials = (
  materials: Material[] | undefined,
): OrganizedMaterials => {
  if (!materials) return { links: [], files: [] };

  const organized: OrganizedMaterials = { links: [], files: [] };
...
export const formatDueDate = (dueDate: Date | null): string | null => {
